...
<div align="center">
    ...
    <form action="ticketbelongssenddelete.php" method="POST">
        <b>FLIGHT ID</b>
        <br>
        <select name="ids">
            ...
            $sql_command = "SELECT fid FROM ticket_belongs_to_flight";
        ...
        <button class="delbtn">DELETE TICKET FLIGHT RELATION INFO</button>
</div>
</form>