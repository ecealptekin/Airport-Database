...
<html>
<head>
    <title>PASSENGER PURCHASED INFO PAGE</title>
...
<div align="center">
    <b>Welcome to our Passenger Purchased Information Insertion Page</b>
    <br>
    <br>
    ...
    <?php
    include "purchasedmessage.php";
    ?>

    <form action="sendpurchasedmsg.php" method="POST">
        <b>Passenger ID</b>
        <br>
        <select name="pids">
            <?php
